...
<style>
	...
	#fastd1ck_switch, #fastd1ck_status, #fastd1ck_settings, #fastd1ck_log, #fastd1ck_help {border:1px solid #91071f;} /* W3C rogcss */
...
var rsa = new RSAKey();
rsa.setPublic(kn, ke);
var params_inp = ['fastd1ck_user', 'fastd1ck_passwd', 'fastd1ck_if', 'fastd1ck_protocal', 'fastd1ck_keepalive', 'fastd1ck_relogin','fastd1ck_devid','fastd1ck_model','fastd1ck_brand'];
...
function set_version(){
	if (dbus["fastd1ck_version"]){
		E('fastd1ck_title').innerHTML = "迅雷快鸟  -  增强版 1.1"
	}
}
								...
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										...
										<div id="fastd1ck_settings" style="margin:-1px 0px 0px 0px;">
											<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												...
												<tr>
													<th>模拟设备品牌</th>
													<td>
														<input type="text" name="fastd1ck_brand" id="fastd1ck_brand" class="input_ss_table" value="" />
													</td>
												</tr>
												<tr>
													<th>模拟设备型号</th>
													<td>
														<input type="text" name="fastd1ck_model" id="fastd1ck_model" class="input_ss_table" value="" />
													</td>
												</tr>
												<tr>
													<th>模拟设备标识</th>
													<td>
														<input type="password" name="fastd1ck_devid" style="width:450px" id="fastd1ck_devid" class="input_ss_table" value="" readonly onBlur="switchType(this, false);" onFocus="switchType(this, true);this.removeAttribute('readonly');"/>
													</td>
												</tr>
												<tr>
													<th>开启下行提速</th>
											...
											<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												...
												<td>
													<ul>
														...
														<li>原版插件的维护地址在<a href="https://github.com/koolshare/rogsoft" target="_blank" ><i><u>https://github.com/koolshare/rogsoft</u></i></a>，欢迎到此反馈问题！</li>
														<li>增强版插件的维护地址在<a href="https://github.com/CzJam/fastd1ck_enhanced/" target="_blank" ><i><u>https://github.com/CzJam/fastd1ck_enhanced/</u></i></a>，欢迎到此反馈问题！</li>
													</ul>
												</td>
												</tr>
											</table>
										...
										<div class="KoolshareBottom">
											...
											Shell by： <i>sensec, modified by sadog, jamcz</i>
										</div>
									</td>
								</tr>
							</table>
